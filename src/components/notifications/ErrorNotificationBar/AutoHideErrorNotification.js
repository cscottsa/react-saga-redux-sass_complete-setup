...
import { doAutoHideErrorNotification, updateNotificationActive } from '../../../modules/notifications/actions';

// THE GENERAL NOTIFICATION IS REQUIRED WHEN USING THIS COMPONENT
// THE GENERAL NOTIFICATION IS REQUIRED WHEN USING THIS COMPONENT
// THE GENERAL NOTIFICATION IS REQUIRED WHEN USING THIS COMPONENT

class AutoHideErrorNotification extends Component {
  constructor(props) {
    super(props);
  ...
  componentWillUpdate(nextProps) {
    ...
    if (nextProps.autoHide === true) {
      ...
      this.props.doAutoHideErrorNotification(false);
      return false;
    }
  }
...
function mapStateToProps(state) {
  return {
    autoHide: state.notifications.errorNotification.autoHide,
  };
}

export default connect(mapStateToProps, {
  doAutoHideErrorNotification,
  updateNotificationActive
})(AutoHideErrorNotification);


AutoHideErrorNotification.propTypes = {
  children: PropTypes.node,
  autoHide: PropTypes.bool, // eslint-disable-line
  doAutoHideErrorNotification: PropTypes.func,
